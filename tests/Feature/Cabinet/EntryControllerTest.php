...
class EntryControllerTest extends TestCase
{
    public function testIndexAction()
    {
        ...
        $this->actingAs($this->user)
            ->json('get', 'api/v1/cabinet/entries')
    ...
    public function testCreateAction()
    {
        ...
        $response = $this->actingAs($this->user)
            ->postJson('api/v1/cabinet/entry', $data);
    ...
    public function testShowAction()
    {
        ...
        $response = $this->actingAs($this->user)
            ->get('api/v1/cabinet/entry/' . $entry->id);
    ...
    public function testUpdateAction()
    {
        ...
        $this->actingAs($this->user)
            ->put('api/v1/cabinet/entry/' . $entry->id, $data)
            ->assertStatus(Response::HTTP_OK)
            ->assertJson(
                [
                    'id' => $entry->id,
    ...
    public function testAddNotArrayFiles()
    {
        ...
        $this->actingAs($this->user)
            ->json('post', 'api/v1/cabinet/entry', $data)
    ...
    public function testUpdateForMissingData()
    {
        ...
        $this->actingAs($this->user)
            ->put('api/v1/cabinet/entry/0', $data)
            ->assertStatus(Response::HTTP_NOT_FOUND);
    }
}
